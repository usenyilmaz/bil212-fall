...
public class LinkedPositionalList<E> implements PositionalList<E> {
  ...
  protected class PositionIterator implements Iterator<Position<E>> {
    ...
    public void set(E item) throws IllegalStateException {
      if (recent == null) {
        throw new IllegalStateException("next() has not been called or element has been removed.");
      }
      LinkedPositionalList.this.set(recent, item); // use the outer list's set method
    }
  ...
  protected class ElementIterator implements Iterator<E> {
    ...
    public void set(E item){
      ((PositionIterator) posIterator).set(item);
    }
  }
